...
async function main() {
    ...
    await prisma.product.create({
        data: {
            ...
            price: 45000,
            image: '/images/men-ensemble-white.jpg?v=2',
    ...
    await prisma.product.create({
        data: {
            ...
            price: 120000,
            image: '/images/men-grand-boubou-green.jpg?v=2',
            brand: 'Bazin Riche',
            size: 'XL',
    ...
    await prisma.product.create({
        data: {
            ...
            price: 35000,
            image: '/images/men-tunic-brown.jpg?v=2',
            brand: 'Modern Man',
            size: 'M',
            condition: 'Bon état',
            userId: user1.id,
    ...
    await prisma.product.create({
        data: {
            ...
            price: 60000,
            image: '/images/men-boubou-white-details.jpg?v=2',
    ...
    await prisma.product.create({
        data: {
            ...
            price: 25000,
            image: '/images/men-sportswear-white.jpg?v=2',
            brand: 'Urban Style',
            size: 'M',
            condition: 'Très bon état',
            userId: user1.id,
    ...
    await prisma.product.create({
        data: {
            ...
            price: 65000,
            image: '/images/ankara-dress-colorful.jpg?v=2',
    ...
    await prisma.product.create({
        data: {
            ...
            price: 125000,
            image: '/images/wax-ensemble-yellow.jpg?v=2',
            brand: 'Afro Couture',
            size: 'L / 40 / 12',
    ...
    await prisma.product.create({
        data: {
            ...
            price: 85000,
            image: '/images/african-fashion-modern.jpg?v=2',
            brand: 'Dakar Fashion',
            size: 'M / 38 / 10',
            condition: 'Très bon état',
            userId: user1.id,
    ...
    await prisma.product.create({
        data: {
            ...
            price: 450000,
            image: '/images/wedding-dress-white.jpg?v=2',
            brand: 'Torodo Bridal',
            size: 'L / 40 / 12',
            condition: 'Neuf',
            userId: user2.id,
    ...
    await prisma.product.create({
        data: {
            ...
            price: 55000,
            image: '/images/wax-coat-colorful.jpg?v=2',
            brand: 'Afro Style',
            size: 'S / 36 / 8',
