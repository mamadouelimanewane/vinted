  ...
  return (
    <section className="hero">
      ...
      <style jsx>{`
        .hero {
          height: 600px;
          background: linear-gradient(to right, rgba(0,0,0,0.3), rgba(0,0,0,0.2)), url('https://images.unsplash.com/photo-1509631179647-0177331693ae?q=80&w=2070&auto=format&fit=crop');
